          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {[
                ...
                <button
                  key={tag}
                  className="px-4 py-2 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white rounded-full text-sm transition-all hover:shadow-[0_0_10px_rgba(255,107,53,0.3)]"
                >
                  {tag}
                </button>
              ))}
