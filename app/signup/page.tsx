          ...
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              <Link href="/dashboard" className="inline-block">
                <h1 className="text-4xl font-bold transition-all duration-300 hover:scale-105">
                  <span className="text-white">Bonk</span>
                  <span className="bg-orange-500 text-black px-2 py-1 rounded ml-1">hub</span>
                </h1>
              </Link>
              <p className="text-gray-400 mt-2">Create your analytics account</p>
            </div>
            ...
            <Card className="bg-gray-900 border-gray-800 transition-all duration-300 hover:border-[#ff6b35]/50 hover:shadow-[0_0_20px_rgba(255,107,53,0.3)] hover:scale-[1.02]">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  Create your account to access powerful analytics
                </CardDescription>
              </CardHeader>
              <CardContent>
