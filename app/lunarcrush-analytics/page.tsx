...
import { TrendingUp, Users, MessageCircle, Activity, BarChart3, LineChart as LineChartIcon, PieChart, Target, Zap, TrendingDown } from "lucide-react"
...
export default function LunarCrushAnalyticsPage() {
  ...
  const getSentimentIcon = (sentiment: number) => {
    ...
    if (sentiment >= 50) return <Target className="h-4 w-4" />
      ...
      <div className="min-h-screen bg-gray-900 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-white mt-4">Loading LunarCrush Analytics...</p>
          </div>
        </div>
      </div>
    )
  ...
  const priceChange = previousData ? ((latestData.close - previousData.close) / previousData.close) * 100 : 0
  const sentimentChange = previousData ? latestData.sentiment - previousData.sentiment : 0
  const interactionsChange = previousData ? ((latestData.interactions - previousData.interactions) / previousData.interactions) * 100 : 0
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-2">
            LunarCrush Analytics Dashboard
          </h1>
          <p className="text-gray-400 text-lg">
            Real-time social sentiment and market performance analytics for BONK
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-400">{formatPrice(latestData.close)}</div>
              <div className={`text-sm ${priceChange >= 0 ? 'text-green-400' : 'text-red-400'} flex items-center gap-1`}>
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-400">{latestData.sentiment}</div>
              <div className={`text-sm ${sentimentChange >= 0 ? 'text-green-400' : 'text-red-400'} flex items-center gap-1`}>
                {sentimentChange >= 0 ? '+' : ''}{sentimentChange.toFixed(1)}
                {getSentimentIcon(latestData.sentiment)}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-400">{formatNumber(latestData.interactions)}</div>
              <div className={`text-sm ${interactionsChange >= 0 ? 'text-green-400' : 'text-red-400'} flex items-center gap-1`}>
                {interactionsChange >= 0 ? '+' : ''}{interactionsChange.toFixed(1)}%
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-cyan-400">{latestData.galaxy_score}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-300">Market Cap</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-xl font-bold text-white">${formatNumber(latestData.market_cap)}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent>
              <div className="text-xl font-bold text-white">${formatNumber(latestData.volume_24h)}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent>
              <div className="text-xl font-bold text-white">#{latestData.alt_rank}</div>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="charts" className="space-y-4">
          <TabsList className="bg-gray-800 border-gray-700">
            <TabsTrigger value="charts" className="data-[state=active]:bg-orange-500 data-[state=active]:text-black">
              Interactive Charts
            </TabsTrigger>
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">
                  Compare different metrics over time with interactive visualizations
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr>
                          ...
                          {['Price', 'Sentiment', 'Interactions', 'Contributors', 'Posts', 'Galaxy', 'Social Dom', 'Alt Rank'].map(label => (
