...
export function SocialTab({
  ...
  const { debouncedSearchQuery } = useMetaSearchStore();
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      {/* Social Feed Column - 2/3 width on large screens */}
      <div className="lg:col-span-2">
        <Card className="group/social-feed bg-gray-900 border-gray-700 hover:shadow-[0_0_15px_rgba(255,107,53,0.2)] hover:border-orange-500/40 transition-all duration-500 transform-gpu cursor-pointer">
          <CardHeader className="flex flex-row items-center justify-between">
          ...
          <CardContent className="space-y-4">
            {currentPosts.map((p) => {
              ...
              return (
                <div
                  key={id}
                  className="group/post p-4 border border-gray-700 rounded-lg hover:bg-gray-800 hover:border-orange-500/50 hover:shadow-[0_0_8px_rgba(255,107,53,0.2)] transition-all duration-500 transform-gpu cursor-pointer"
                >
      ...
      {/* Influencer List Column - 1/3 width on large screens */}
      <div className="lg:col-span-1">
        <InfluencerList tokenId={debouncedSearchQuery || "bonk"} limit={10} />
      </div>
    </div>
  );
}